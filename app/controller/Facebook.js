 ...
 */
Ext.define('frontapp.controller.Facebook', {
    ...
    onFacebookInit: function() {
        if (frontapp.utils.Config.getFacebookAppId() === '') return;

        var me = this;

        FB.init({
            appId  : frontapp.utils.Config.getFacebookAppId(),
            cookie : true
        });
