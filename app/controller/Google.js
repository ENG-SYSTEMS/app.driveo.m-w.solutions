 ...
 */
Ext.define('frontapp.controller.Google', {
    ...
    onGoogleInit: function() {
        ...
        if (frontapp.utils.Config.getGoogleAppId() === '') return;
        ...
        gapi.auth.authorize({client_id: frontapp.utils.Config.getGoogleAppId(), scope: 'https://www.googleapis.com/auth/plus.login', immediate: true, response_type: 'token id_token',cookie_policy: 'single_host_origin'}, me.handleAuthResult);
    ...
    login: function() {
        ...
        if (!splash) {
            Ext.Viewport.add({ xclass: 'frontapp.view.Login', id: 'login' });
        }
    },
        ...
        gapi.client.load('plus', 'v1', function() {
            ...
            request.execute(function(resp) {
                if (resp.error) {
                    ...
                    frontapp.userData = resp;
                    if (!me.main) {
                        me.main = Ext.create('frontapp.view.Main', {
                            id: 'main'
                        });
                    }
    ...
    logout: function() {
        ...
        if (this.connected) {
            ...
            gapi.auth.authorize({client_id: frontapp.utils.Config.getGoogleAppId(), scope: 'https://www.googleapis.com/auth/plus.login', immediate: true}, me.handleAuthResult);
            me.gpLoginTimeout = setTimeout(function() {
