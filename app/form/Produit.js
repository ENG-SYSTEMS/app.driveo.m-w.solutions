Ext.define('frontapp.form.Produit', {
    xtype: 'formProduit',
            ...
            
            {
                ...
                items: [
                    ...
                    },
                    {
                        xtype: 'textfield',
                        width: '100%',
                        name: 'frontappReference',
                        label: 'Elements en frontapp',
                        labelWidth: '80%',
                        clearIcon: false,
                        defaultValue: '1',
                        placeHolder: '0',
    ...
    setRecord: function (record){
        if (this.down('[name=Image]')) {
            ...
            this.down('[action=produitImage]').setSrc(frontapp.utils.Config.getDomain()+'/'+record.get('Image')+'.mini.100x100.jpg');
        }
        ...
        if (this.down('[name=frontappReference]'))
            this.down('[name=frontappReference]').setValue(record.get('frontappReference'));
